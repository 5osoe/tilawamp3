...
const allRecitersSource = [
    ...
    { id: 'nafees', name: 'أحمد النفيس', path: 'ahmed_alnafees/' },
    { id: 'h_jad', name: 'هيثم الجدعاني', path: 'haitham_aljadani/' }
];
...
const surahNames = [
    ...
    "التكوير", "الانفطار", "الهمزة", "المطففين", "الانشقاق", "البروج", "الطارق", "الأعلى", "الغاشية", "الفجر", "البلد",
